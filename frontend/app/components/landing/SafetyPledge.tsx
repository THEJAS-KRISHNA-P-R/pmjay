...
export function SafetyPledge() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-800 via-teal-900 to-teal-950 p-7 sm:p-10 text-white shadow-xl"
    >
      <div className="relative space-y-6">
        <div className="max-w-xl space-y-2">
          <div className="badge bg-white/10 border-white/15 text-teal-200">
          ...
          <p className="text-sm sm:text-base text-teal-100/85 leading-relaxed font-medium">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {pledges.map((p) => (
            <div key={p.title} className="rounded-2xl bg-white/10 p-5 space-y-2.5">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/15 text-teal-100">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-t border-white/15 pt-6 text-xs sm:text-sm text-teal-100/90 font-medium">
