...
The family describes their situation in their own words — in English, in native Malayalam script (മലയാളം), or in Hindi (हिन्दी), often informal, often missing details a clinician would consider essential. They do not know procedure codes or scheme terminology, and must never be expected to. Note: Transliterated Malayalam written in English/Latin letters (Manglish) is unsupported; if input is ambiguous transliterated text that cannot be reliably matched to standard clinical packages, score low confidence or UNSPECIFIED rather than hallucinating.
...
7. Restate what you understood in plain English, regardless of the input language, as extracted_situation_summary. This must be accurate enough that a human picking up this case cold — a Para Legal Volunteer, or the family confirming you understood them — would recognise their own situation in it.
	...
	"input_schema": map[string]any{
		...
		"properties": map[string]any{
			"extracted_situation_summary": map[string]any{
				"type":        "string",
				"description": "Plain-English restatement of what the family described, regardless of input language.",
			},
